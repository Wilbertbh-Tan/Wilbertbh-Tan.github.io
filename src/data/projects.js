...
computer vision system for automated dietary assessment and nutritional tracking. recognizes food items from smartphone photos and estimates portion sizes for instant nutritional information.

## my role

co-founder and technical lead - built food recognition models, developed mobile application, and pitched at startup competitions.

## innovative features

**single-image portion estimation:** estimates food quantity from photos without reference objects, using learned priors about typical food presentations and plate sizes.

**multi-food scene detection:** handles complex meal photos with multiple food items, segmenting and classifying each component separately.

**real-time mobile inference:** optimized models for responsive on-device processing, enabling instant feedback as users photograph their meals.

## impact

first prize at australian health startup competition (2016). demonstrated feasibility of ai-powered dietary tracking for consumer health applications.
    `,
    links: {
      github: null,
      live: null
...
high-speed transportation pod for spacex hyperloop competition, developed with keioalpha team. designed propulsion, levitation, and braking systems for low-pressure tube environment.

## my role

mechanical design team member - contributed to aerodynamic shell design, structural analysis, and thermal management. helped prepare technical documentation and presentations for spacex judges.

## innovative features

**low-pressure aerodynamics:** pod shell optimized for near-vacuum tube environment with different drag characteristics than atmospheric flight.

**integrated systems design:** propulsion, levitation, braking, and safety systems designed together for weight optimization and reliability.

**modular architecture:** designed for rapid iteration and testing during competition development cycle.

## impact

top 30 finalist among 120+ teams worldwide. presented design at spacex hyperloop competition at texas a&m. contributed to advancing high-speed ground transportation technology.
    `,
    links: {
      github: null,
      live: null
